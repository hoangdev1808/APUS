...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="News" mode="Bigimg">
        <xsl:if test="position()=1">
			<div class="section-title-child text-center line" data-aos="fade-down">
				<p>
            ...
            <div class="img-desc" data-aos="fade-up">
                <img >
    ...
    <xsl:template match="News" mode="Smallimg">
        <xsl:if test="position()!=1">
            <div class="filed-item">
                <div class="row">
                    <div class="col-xl-8 col-md-6 left" data-aos="fade-left">
                        <div class="img">
                            <img >
                                <xsl:attribute name="src">
                                    <xsl:value-of select="ImageUrl"></xsl:value-of>
                    ...
                    <div class="col-xl-4 col-md-6 right" data-aos="fade-right">
