	...
	if (c) {
		(j = function (a) {
			...
			(d = function (b) {
				...
				return (
					c
						.getContext("2d")
						.clearRect(0, 0, a(b).width(), a(b).height()),
					c
				);
			});
		var n = function (a, b, c, d, e) {
			if (((d = d || 0), (e = e || 0), a.beginPath(), "rect" == b))
				...
				"circ" == b &&
					a.arc(c[0] + d, c[1] + e, c[2], 0, 2 * Math.PI, !1);
			a.closePath();
		};
		(e = function (b, c, d, e, f) {
			...
			if (e.shadow) {
				g.save(),
					"inside" == e.shadowPosition && (n(g, c, d), g.clip());
				var h = 100 * b.width,
					i = 100 * b.height;
				n(g, c, d, h, i),
			...
			g.save(),
				n(g, c, d),
				e.fill &&
					((g.fillStyle = k(e.fillColor, e.fillOpacity)), g.fill()),
				e.stroke &&
		...
		(d = function (b) {
			...
			(f = function (b) {
				...
				c.children("[name=highlighted]").remove(),
					(b.innerHTML = c.html());
			});
	(g = function (a) {
		var b,
						...
						a(o)
							...
							.bind(
								...
								function (b) {
									...
									if (
										((f = m(h, n)),
										!f.neverOn && !f.alwaysOn)
									) {
										if (
											((d = g(h)),
											e(p, d[0], d[1], f, "highlighted"),
											f.groupBy)
										) {
											var i;
											i = /^[a-zA-Z][\-a-zA-Z]+$/.test(
												f.groupBy
											)
												? o.find(
														"area[" +
